        ...
        <Table.Body>
          {
            apiData.map(data => (
              <Table.Row key={data.id} className='tablerow'>
                ...
                <Table.Cell className='tabelcol'><FaEdit onClick={() => updateUser(data)} className='edit-del'/></Table.Cell>
                <Table.Cell className='tabelcol'><MdDelete onClick={() => deleteUser(data)}className='edit-del' /></Table.Cell>
              </Table.Row>
            ))
          }
